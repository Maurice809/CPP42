...
/*   Updated: 2023/02/18 10:14:37 by aducret          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::FileOpenException::FileOpenException(void)
{
}

Form::FileOpenException::FileOpenException(FileOpenException const & src)
{
	*this = src;
}

Form::FileOpenException::~FileOpenException(void) throw()
{
}

Form::FileOpenException & Form::FileOpenException::operator=(FileOpenException const & rhs)
{
	(void)rhs;
	return *this;
}
